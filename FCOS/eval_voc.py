...
if __name__=="__main__":
    ...
    eval_dataset = VOCDataset(root_dir='/home/shichenqiao/VOCdevkit/VOC2007', resize_size=[800, 1333],
    ...
    model.load_state_dict(torch.load("/home/shichenqiao/FCOS-PyTorch-37.2AP/checkpoint/model_50.pth",map_location=torch.device('cpu')))
