...
train_dataset = VOCDataset(root_dir='/home/shichenqiao/VOCdevkit/VOC2007',resize_size=[800,1333],
...
for epoch in range(EPOCHS):
    ...
    plt.xlabel('epoch')
    plt.legend()
    plt.savefig(os.path.join("/home/shichenqiao/FCOS-PyTorch-37.2AP/","loss.jpg"))
